...
%
 write_curv('Fig_2a_left_NEW.curv',vol,163824);
...
write_curv('Fig_2a_right_NEW.curv',vol,163824);
...
for i = 1:length(est_lh)
 ...
 vol = reshape(vol,[163842,1,1,1]);%translate into 4d matrix
%
 write_curv('Fig_2b_left_NEW.curv',vol,163824);
...
write_curv('Fig_2b_middle_NEW.curv',vol,163824);
...
write_curv('Fig_2b_right_NEW.curv',vol,163824);
...
write_curv('Fig_S5a_NEW.curv',vol,163824);
...
write_curv('Fig_S5b_NEW.curv',vol,163824);
